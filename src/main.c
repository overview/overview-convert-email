...
print_mime_warning(gint64 offset, GMimeParserWarning errcode, const gchar* item, gpointer user_data)
{
	...
	const char* message;
	switch (errcode) {
		case GMIME_WARN_DUPLICATED_CONTENT_HDR: message = "GMIME_WARN_DUPLICATED_CONTENT_HDR"; break;
		case GMIME_WARN_DUPLICATED_PARAMETER: message = "GMIME_WARN_DUPLICATED_PARAMETER"; break;
		...
		case GMIME_WARN_INVALID_HEADER: message = "GMIME_WARN_INVALID_HEADER"; break;
		...
		case GMIME_CRIT_CONFLICTING_CONTENT_HDR: message = "GMIME_CRIT_CONFLICTING_CONTENT_HDR"; break;
